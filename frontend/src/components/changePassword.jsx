...
//         "http://192.168.169.198:8000/user/change-password",
...
const ChangePassword = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      const response = await axios.post("http://192.168.169.198:8000/user/forgot-password", { email });      
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      const response = await axios.post("http://192.168.169.198:8000/user/verify-forgot-password", { email, otp, otpGenerated });
      if (response.status === 200) {
