  ...
  return (
    <footer className="bg-black py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-center text-gray-300 text-sm mb-4">About Us: Discover inspiring stories, insightful articles, and expert advice on our platform dedicated to sharing knowledge and fostering community.</p>
        <p className="text-center text-gray-300 text-sm">&copy; 2024 Blogify | Harsh Pathak. All rights reserved.</p>
      </div>
    </footer>
  );
};
