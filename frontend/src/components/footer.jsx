    ...
    <footer className="relative bg-transparent py-8 border-t border-white/20">
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="flex justify-center mb-8 space-x-8">
          ...
          <a
            href=""
            className="text-white/70 hover:text-white transform hover:scale-110 transition-all duration-300 p-3 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 hover:border-white/40"
          >
            <svg
